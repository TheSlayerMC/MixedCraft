...
public class BlockGoldFurnace extends BlockModContainer
{
	...
	public BlockGoldFurnace(boolean par2, String name) {
	...
	{
		return Item.getItemFromBlock(BlockHelper.goldFurnace);
	}
	...
	public static void updateGoldFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
	{
		...
		{
			par1World.setBlock(par2, par3, par4, BlockHelper.goldFurnace);
		}
